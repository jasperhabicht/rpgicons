...
\def\dndiconsfileversion{1.5.1}
\def\dndiconsfiledate{28 February 2024}
...
\NewDocumentCommand{\dndiconslogo}{ O{1} }{
    \draw_begin:
        ...
        \int_step_inline:nn { \clist_count:N \l_dndicons_doc_logo_icons_clist } {
            ...
            \draw_scope_begin:
                \draw_transform_shift:n { \draw_point_polar:nn { 0.33cm } { 60 * ##1 + 10 } }
