...
\ExplSyntaxOn
\cs_undefine:c { die }
\cs_undefine:c { die ~ code }
\cs_undefine:c { die ~ defaults }
\cs_undefine:c { ability }
\cs_undefine:c { ability ~ code }
\cs_undefine:c { ability ~ defaults }
\ExplSyntaxOff
