...
\changes{v1.4.4}{2024/02/24}{Added styles for every instance of command or shape, correction of recent changes to \titlemacro{l3draw} code.}
...
\subsection[Commands \textbackslash damage, \textbackslash attack, \textbackslash condition and \textbackslash currency]{Commands \titlemacro*{damage}, \titlemacro*{attack}, \titlemacro*{condition} and \titlemacro*{currency}}
