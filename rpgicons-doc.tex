...
Instead of \macro{\DocumentMetadata{}}, \macro{\RequirePackage{pdfmanagement}} can be called before \macro{\documentclass} to enable the above described color and transparency management.
