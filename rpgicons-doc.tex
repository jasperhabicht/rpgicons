...
\def\rpgiconsfileversion{2.3.4}
\def\rpgiconsfiledate{15 January 2026}
...
\changes{v2.3.4}{2026/01/15}{Added variants for class shapes.}
...
\macro{\ability}
    ...
    & \ability{wisdom alt} & \macro{wisdom alt} \\
...
\macro{\saving}
    ...
    & \saving{wisdom alt} & \macro{wisdom alt} \\
