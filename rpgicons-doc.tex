...
\def\rpgiconsfileversion{2.2.1}
\def\rpgiconsfiledate{6 November 2025}
...
\changes{v2.2.0}{2025/11/05}{Added shapes for ritual spell, gems and jewelry as well as for classes. Fixes in alignment shapes and in pic definitions.}
\changes{v2.2.1}{2025/11/06}{Fixes in transformation keys in L3 variant.}
...
\macro{\currency}
    ...
    & \currency{jewelry}{} & \macro{jewelry} or \macro{jewellery} \\
\end{rpgiconsiconlist}
