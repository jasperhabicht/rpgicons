...
|actualtext|={<string>}
\end{macrodef}
The option \macro{actualtext} can be used to change the default replacement text that is used for example by screen readers in a tagged PDF. It expects a string representing the relevant replacement text.
