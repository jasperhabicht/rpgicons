...
\def\rpgiconsfileversion{2.5.1}
\def\rpgiconsfiledate{3 February 2026}
...
\lstdefinestyle{rpgiconsdocmacro}{
    ...
    literate={<<}{{{\bfseries\color{black!50}\guilsinglleft}}}{1}
...
\changes{v2.5.1}{2026/02/03}{Added key to generate alias for shapes in L3 variant. Update documentation.}
