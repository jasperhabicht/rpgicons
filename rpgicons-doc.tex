...
The command supports PDF tagging. If tagging is activated, a replacement text to the relevant icon is automatically added which can be copied to the clipboard and can be read by screen readers. Note that support of tagged PDFs depends on the used PDF reader.
