...
\def\rpgiconsfileversion{2.0.4}
\def\rpgiconsfiledate{21 October 2025}
...
every <shape> add
\end{macrodef}
Styles following the pattern \macro{every} followed by a space and the name of the command or the shape followed by another space and \macro{add} work in the same way as the styles described above, but insteaf of overwriting existing styles, they append the relevant styles.
