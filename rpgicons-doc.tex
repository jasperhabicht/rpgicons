...
\def\rpgiconsfileversion{2.5.0}
\def\rpgiconsfiledate{27 January 2026}
...
\changes{v2.5.0}{2026/01/27}{Added variants for paladin and monk shapes. Standardization of key names.}
...
Note that the key \macro{style appemd} has been deprecated and the key \macro{style add} key should be used instead.
...
Note that the key \macro{!rpg icons/!background color} has been deprecated and the key \macro{!rpg icons/!background} key should be used instead.
